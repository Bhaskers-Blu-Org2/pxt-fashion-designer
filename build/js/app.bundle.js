...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "6349212c53a85f630cf7";
...
(function (pxt) {
    ...
    (function (extensions) {
        ...
        function write(code, json) {
            ...
            var msg = mkRequest('extwritecode');
            msg.body = {
                code: code,
                json: json
            };
        ...
        function queryPermission() {
            if (!inIframe())
                return;
            var msg = mkRequest('extquerypermission');
            window.parent.postMessage(msg, "*");
        }
        ...
        function requestPermission(serial) {
            if (!inIframe())
                return;
            var msg = mkRequest('extrequestpermission');
            msg.body = {
                serial: serial
            };
            window.parent.postMessage(msg, "*");
        ...
        function dataStream(serial) {
            if (!inIframe())
                return;
            var msg = mkRequest('extdatastream');
            msg.body = {
                serial: serial
            };
            window.parent.postMessage(msg, "*");
...
var factory_1 = __webpack_require__(/*! ./exporter/factory */ "./src/exporter/factory.ts");
var App = (function (_super) {
    ...
    function App(props) {
        ...
        _this.deserialize = _this.deserialize.bind(_this);
        _this.serialize = _this.serialize.bind(_this);
        props.client.on('read', _this.deserialize);
        props.client.on('hidden', _this.serialize);
        return _this;
    }
    ...
    App.prototype.serialize = function () {
        ...
        var emitter = factory_1.EmitterFactory.getEmitter(target);
        if (!emitter)
            return;
        var code = emitter.output(undefined);
        var json = {};
        pxtextensions_1.pxt.extensions.write(code, JSON.stringify(json));
    };
    App.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "App" },
            ...
            React.createElement("span", null, "Go back to the editor, to see your new block under the music category")));
    };
    return App;
}(React.Component));
exports.App = App;
...
var PXTExtension = (function (_super) {
    ...
    PXTExtension.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "PXTExtension " + (!target ? 'dimmable dimmed' : '') }, !isSupported ? React.createElement("div", null, "This extension is not supported in your browser") : React.createElement(App_1.App, { client: this.client, target: target })));
    };
    PXTExtension.DEFAULT_TARGET = 'microbit';
    return PXTExtension;
}(React.Component));
...
var Hello = (function (_super) {
    ...
    Hello.prototype.render = function () {
        return (React.createElement("div", { className: "Hello" }, "Hello from MakeCode!"));
    };
    return Hello;
}(React.Component));
exports.Hello = Hello;
...
Object.defineProperty(exports, "__esModule", { value: true });
var AbstractEmitter = (function () {
    function AbstractEmitter() {
    }
    AbstractEmitter.prototype.outputHeader = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var abstract_1 = __webpack_require__(/*! ./abstract */ "./src/exporter/abstract.ts");
var ConcreteEmitter = (function (_super) {
    __extends(ConcreteEmitter, _super);
    function ConcreteEmitter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ConcreteEmitter.prototype.output = function (obj) {
...
}(abstract_1.AbstractEmitter));
exports.ConcreteEmitter = ConcreteEmitter;


/***/ }),

/***/ "./src/exporter/factory.ts":
/*!*********************************!*\
  !*** ./src/exporter/factory.ts ***!
  \*********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var concrete_1 = __webpack_require__(/*! ./concrete */ "./src/exporter/concrete.ts");
var EmitterFactory = (function () {
    function EmitterFactory() {
    }
    EmitterFactory.getEmitter = function (target) {
        return new concrete_1.ConcreteEmitter();
    };
