...
// This is just to get `as namespace fabric;` to work and to be re-exportable from `index.d.ts`.
...
declare namespace fabric {
     ...
     */
    function createSVGRefElementsMarkup(canvas: StaticCanvas): string;
    /**
     * Creates markup containing SVG font faces
     * @param objects Array of fabric objects
     */
    function createSVGFontFacesMarkup(objects: Object[]): string;
    /**
     * Takes string corresponding to an SVG document, and parses it into a set of fabric objects
     * @param [reviver] Method for further parsing of SVG elements, called after each fabric object created.
     */
    function loadSVGFromString(string: string, callback: (results: Object[], options: any) => void, reviver?: Function): void;
    /**
     * Takes url corresponding to an SVG document, and parses it into a set of fabric objects.
     * Note that SVG is fetched via XMLHttpRequest, so it needs to conform to SOP (Same Origin Policy)
     * @param [reviver] Method for further parsing of SVG elements, called after each fabric object created.
     */
    function loadSVGFromURL(url: string, callback: (results: Object[], options: any) => void, reviver?: Function): void;
    /**
     ...
     * @param [reviver] Method for further parsing of SVG elements, called after each fabric object created.
     */
    function parseElements(elements: SVGElement[], callback: Function, options?: any, reviver?: Function): void;
    /**
     ...
     * @param [reviver] Method for further parsing of SVG elements, called after each fabric object created.
     */
    function parseSVGDocument(doc: SVGElement, callback: (results: Object[], options: any) => void, reviver?: Function): void;
    /**
    ...
    interface Gradient extends IGradientOptions { }
    class Gradient {
        /**
    ...
    interface Pattern extends IPatternOptions { }
    class Pattern {
    ...
    interface Shadow extends IShadowOptions { }
    class Shadow {
    ...
    interface StaticCanvas extends IObservable<StaticCanvas>, IStaticCanvasOptions, ICollection<StaticCanvas>, ICanvasAnimation<StaticCanvas> { }
    class StaticCanvas {
        /**
         * Constructor
    ...
    interface Canvas extends ICanvasOptions { }
    class Canvas {
        /**
         * Constructor
    ...
    interface Circle extends Object, ICircleOptions { }
    class Circle {
    ...
    interface Ellipse extends Object, IEllipseOptions { }
    class Ellipse {
    ...
    // ActiveSelection
    //////////////////////////////////////////////////////////////////////////////
    interface ActiveSelection extends Group, ICollection<Group> { }
    ...
    interface Line extends Object, ILineOptions { }
    class Line {
        /**
         * Constructor
    ...
    interface Object extends IObservable<Object>, IObjectOptions, IObjectAnimation<Object> { }
    class Object {
    ...
    interface Path extends Object, IPathOptions { }
    class Path {
        /**
         * Constructor
    ...
    interface Polygon extends IPolylineOptions { }
    ...
    interface Polyline extends IPolylineOptions { }
    ...
    interface Rect extends IRectOptions { }
    ...
    interface Text extends TextOptions { }
    ...
    interface IText extends ITextOptions { }
    ...
    interface Textbox extends ITextboxOptions { }
    ...
    interface Canvas2dFilterBackend extends FilterBackend { }
    ...
    interface WebglFilterBackendOptions {
        tileSize: number;
    }
    interface WebglFilterBackend extends FilterBackend, WebglFilterBackendOptions {
